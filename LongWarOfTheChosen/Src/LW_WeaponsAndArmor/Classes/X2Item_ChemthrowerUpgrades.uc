...
static function X2DataTemplate CreateBasicWidthNozzle()
{
	...
	Template.strImage = "img:///LWIRIClausImmolator_LW.UI_Upgrades.HighVolumeInjector_MG";
...
static function X2DataTemplate CreateBasicLengthNozzle()
{
	...
	Template.strImage = "img:///LWIRIClausImmolator_LW.UI_Upgrades.PressurizedInjector_MG";
	Template.RewardDecks.AddItem('ChemthrowerUpgradeBsc');
...
static function SetUpWidthNozzleUpgrade(out X2WeaponUpgradeTemplate Template)
{
	...
	{
		Template.AddUpgradeAttachment('Suppressor', '', "", "", ChemTemplateName, , "img:///LWIRIClausImmolator_LW.UI_MG.FlamerMG_HighCapacityInjector_MG_", Template.strImage, "img:///UILibrary_StrategyImages.X2InventoryIcons.Inv_weaponIcon_barrel");
	}
...
static function SetUpLengthNozzleUpgrade(out X2WeaponUpgradeTemplate Template)
{
	...
	foreach default.ChemthrowerTemplateNames(ChemTemplateName)
	{
		Template.AddUpgradeAttachment('Suppressor', '', "", "", ChemTemplateName, , "img:///LWIRIClausImmolator_LW.UI_MG.FlamerMG_PressurizedInjector_MG_", Template.strImage, "img:///UILibrary_StrategyImages.X2InventoryIcons.Inv_weaponIcon_barrel");
	}
...
static function X2DataTemplate CreateBasicClipSizeFuel()
{
	...
	SetUpTier1Upgrade(Template);
	Template.strImage = "img:///LWIRIClausImmolator_LW.UI_Upgrades.ExpandedFuelTank_MG";
...
static function SetUpClipSizeBonusFuel(X2WeaponUpgradeTemplate Template)
{
	...
	foreach default.ChemthrowerTemplateNames(ChemTemplateName)
	{
		Template.AddUpgradeAttachment('Mag', '', "", "", ChemTemplateName, , "img:///LWIRIClausImmolator_LW.UI_MG.FlamerMG_ExpandedFuelTank_MG_", Template.strImage, "img:///UILibrary_StrategyImages.X2InventoryIcons.Inv_weaponIcon_clip");
	}
...
static function X2DataTemplate CreateBasicReloadFuel()
{
	...
	SetUpTier1Upgrade(Template);
	Template.strImage = "img:///LWIRIClausImmolator_LW.UI_Upgrades.AutoRefuelTank_MG";
...
static function SetUpReloadFuel(out X2WeaponUpgradeTemplate Template)
{
	...
	foreach default.ChemthrowerTemplateNames(ChemTemplateName)
	{
		Template.AddUpgradeAttachment('Mag', '', "", "", ChemTemplateName, , "img:///LWIRIClausImmolator_LW.UI_MG.FlamerMG_AutoRefuelTank_MG_", Template.strImage, "img:///UILibrary_StrategyImages.X2InventoryIcons.Inv_weaponIcon_clip");
	}
...
static function X2DataTemplate CreateBasicFuelLine()
{
	...
	SetUpTier1Upgrade(Template);
	Template.strImage = "img:///LWIRIClausImmolator_LW.UI_Upgrades.FuelLine_MG";
...
static function SetUpFuelLine(out X2WeaponUpgradeTemplate Template)
{
	...
	foreach default.ChemthrowerTemplateNames(ChemTemplateName)
	{
		Template.AddUpgradeAttachment('HeatSink', '', "", "", ChemTemplateName, , "img:///LWIRIClausImmolator_LW.UI_MG.FlamerMG_FuelLine_MG_", Template.strImage, "img:///UILibrary_StrategyImages.X2InventoryIcons.Inv_weaponIcon_battery");
	}
...
static function X2DataTemplate CreateBasicFlankCritFrame()
{
	...
	SetUpTier1Upgrade(Template);
	Template.strImage = "img:///LWIRIClausImmolator_LW.UI_Upgrades.LightBodyFrame_MG";
	//Template.NumFreeReloads = default.FREE_RELOADS_BSC;
...
static function SetUpLightFrameUpgrade(out X2WeaponUpgradeTemplate Template)
{
	...
	foreach default.ChemthrowerTemplateNames(ChemTemplateName)
	{
		Template.AddUpgradeAttachment('Stock', '', "", "", ChemTemplateName, , "img:///LWIRIClausImmolator_LW.UI_MG.FlamerMG_LightBodyFrame_MG_", Template.strImage, "img:///UILibrary_StrategyImages.X2InventoryIcons.Inv_weaponIcon_stock");
	}
...
static function X2DataTemplate CreateBasicReactionFireFrame()
{
	...
	SetUpTier1Upgrade(Template);
	Template.strImage = "img:///LWIRIClausImmolator_LW.UI_Upgrades.Stabilizer_MG";
	//Template.NumFreeReloads = default.FREE_RELOADS_BSC;
...
static function SetUpReactionFrameUpgrade(out X2WeaponUpgradeTemplate Template)
{
	...
	foreach default.ChemthrowerTemplateNames(ChemTemplateName)
	{
		Template.AddUpgradeAttachment('Stock', '', "", "", ChemTemplateName, , "img:///LWIRIClausImmolator_LW.UI_MG.FlamerMG_Stabilizer_MG_", Template.strImage, "img:///UILibrary_StrategyImages.X2InventoryIcons.Inv_weaponIcon_stock");
	}
